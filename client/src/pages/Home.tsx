...
export default function Home() {
  ...
  const [age, setAge] = useState<number>(25); // Add age state
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Get personalized outfit recommendations that fit your occasion and
            budget. Our smart algorithm finds the perfect combination of style
            and savings.
          </p>
        </div>
                ...
                <div className="flex space-x-2">
                  {colorOptions.map((colorOption) => (
                    <button
                      ...
                      onClick={() =>
                        setColor(
                          color === colorOption.value ? "" : colorOption.value
                        )
                      }
            ...
            <div className="mt-8 text-center">
              ...
              >
                ...
                {generateOutfitsMutation.isPending
                  ? "Generating..."
                  : "Generate AI Style Bundles"}
              </Button>
              {(userPhoto || avatarId) && (
                <p className="text-sm text-green-600 mt-2">
                  ✓ AI try-on will be generated with your{" "}
                  {userPhoto ? "photo" : "selected avatar"}
                </p>
              )}
            </div>
          </CardContent>
          ...
          <div className="mb-8">
            <div className="text-center mb-8">
              <div className="inline-flex items-center px-4 py-2 bg-blue-50 text-blue-600 rounded-lg">
                <LoadingSpinner />
                <span className="ml-2">
                  AI is creating your perfect bundles...
                </span>
              </div>
            </div>
            <OutfitSkeletonLoader />
          ...
          <div className="fade-in">
            <div className="flex justify-between items-center mb-6">
              <h3 className="text-2xl font-bold text-gray-900">
                Your AI-Generated Style Bundles
              </h3>
      ...
      <footer className="bg-blue-600 text-white mt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-blue-100 text-sm">
                AI-powered fashion recommendations that fit your budget and
                style preferences.
              </p>
            </div>
            <div>
          ...
          <div className="border-t border-blue-400 mt-8 pt-8 text-center text-blue-100 text-sm">
            <p>
              &copy; 2024 Walmart Style Bundle Builder. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
