...
export function generateLargeProductCatalog(count: number = 1000): Product[] {
...
function generateProduct(id: string, category: string): Product {
...
// Export the generation function
export { generateLargeProductCatalog };
