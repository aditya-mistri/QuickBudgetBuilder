import { pgTable, text, serial, integer, boolean, real, json, timestamp, varchar, index } from "drizzle-orm/pg-core";
...
export const user_preferences = pgTable("user_preferences", {
  ...
  index("user_prefs_idx").on(table.user_id),
]);
...
export const outfits = pgTable("outfits", {
  ...
  index("user_outfits_idx").on(table.user_id),
]);
...
export const cart_items = pgTable("cart_items", {
  ...
  index("user_cart_idx").on(table.user_id),
]);
...
export const insertOutfitSchema = createInsertSchema(outfits).omit({ id: true, created_at: true });
...
export const onboardingSchema = z.object({
  personalizationType: z.enum(['photo', 'occasion'], {
...
export const outfitResponseSchema = z.object({
  ...
  swap_suggestions: z.array(z.object({
